...
public class Bien implements Serializable {
    ...
    @JsonIgnore
    private Set<Client> estInteressePars = new HashSet<>();
    ...
    public Set<Client> getEstInteressePars() {
        return estInteressePars;
    }

    public Bien estInteressePars(Set<Client> clients) {
        this.estInteressePars = clients;
        return this;
    }

    public Bien addEstInteressePar(Client client) {
        this.estInteressePars.add(client);
        client.getClients().add(this);
        return this;
    }

    public Bien removeEstInteressePar(Client client) {
        this.estInteressePars.remove(client);
        client.getClients().remove(this);
        return this;
    }

    public void setEstInteressePars(Set<Client> clients) {
        this.estInteressePars = clients;
    }
